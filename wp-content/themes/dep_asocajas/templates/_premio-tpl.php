<?php
/*
  Template Name: Landing Premio Template
*/

get_template_part('includes/landing-premio/header');

  get_template_part('includes/landing-premio/por-que');

  get_template_part('includes/landing-premio/objetivo');
